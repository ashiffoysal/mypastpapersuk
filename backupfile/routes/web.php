...
Route::get('/blog-details/{id}', [App\Http\Controllers\Frontend\FrontendController::class, 'blogsDetails']);
...
Route::get('/pastpaper', [App\Http\Controllers\Frontend\FrontendController::class, 'pastpaper']);
