        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="breadcrumb-inner">
                    <h2 class="page-title">PastPaperUK: Your Pathway to Exam Excellence | Past Paper | WJEC</h2>
                    <ul class="page-list">
                        <li><a href="{{ url('/') }}">Home</a></li>
                        <li>WJEC Past Paper</li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="intro-area pd-bottom-90 mt-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="title" style="font-size: 30px">WJEC GCSE</h4>
            </div>
            @php
             $allAqaGcseData=DB::table('subjects')->where('board',4)->where('exam_type',1)->where('is_deleted',0)->where('is_active',1)->get()
            @endphp
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="title" style="font-size: 30px">WJEC A Level</h4>
            </div>
            @php
            $allAqaAlevelData=DB::table('subjects')->where('board',4)->where('exam_type',3)->where('is_deleted',0)->where('is_active',1)->get()
           @endphp
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="title" style="font-size: 30px">WJEC AS Level</h4>
            </div>
            @php
            $allAqaAslevelData=DB::table('subjects')->where('board',4)->where('exam_type',4)->where('is_deleted',0)->where('is_active',1)->get()
            @endphp
